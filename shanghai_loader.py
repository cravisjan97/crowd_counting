...
class Shanghai_Dataset():
    def __init__(self, data_path, gt_path, gt_downsample=False, pre_load=False):
        ...
        if self.pre_load:
            ...
            for fname in self.data_files:
                ...
                raw_img = cv2.imread(os.path.join(self.data_path,fname))
